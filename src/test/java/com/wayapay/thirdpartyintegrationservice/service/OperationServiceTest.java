...
class OperationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        operationService = new OperationService(paymentTransactionRepo, walletFeignClient, categoryService, profileFeignClient, notificationFeignClient, logFeignClient);
    }
